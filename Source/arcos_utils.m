...
% *Inputs*
%
% * *dataloc* - |Struct| - dataloc struct or cell array of (can be mixed) dataloc structs and paths to datalocs
% * *channel* - |Cell|, |String| - ARCOS channel you want to convert (ex: EKAR), can be cell array for each dataloc or single channel
% 
% *Optional Inputs*
%
% * *tstartaftertx* - |Integer| -how many HOURS before starting to consider data after the given treatment (default is 0)
...
% * *txs* - |Cell| - txs to consider (default = {'pTx','Tx1','Tx2','Tx3','Tx4'})
% 
...
% *Inputs*
%
% * *dataloc* - |Struct| - dataloc struct
% * *channel* - |String| - Name of the channel(s) to use
%
% *Optional inputs*
%
% * *tktm*
